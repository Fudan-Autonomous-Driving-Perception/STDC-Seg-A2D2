...
class ContextPath(nn.Module):
    def __init__(self, backbone='CatNetSmall', pretrain_model='', use_conv_last=False, *args, **kwargs):
        ...
        if backbone == 'STDCNet1446':
            ...
            self.arm4 = AttentionRefinementModule(64, 128)
            ...
            self.conv_head4 = ConvBNReLU(128, 128, ks=3, stride=1, padding=1)
            self.conv_avg = ConvBNReLU(inplanes, 128, ks=1, stride=1, padding=0)
        else:
    ...
    def forward(self, x):
        ...
        feat4_arm = self.arm4(feat4)
        feat4_sum = feat4_arm + feat8_up
        feat4_up = F.interpolate(feat4_sum, (H2, W2), mode='nearest')
        feat4_up = self.conv_head4(feat4_up)
        
        return feat2, feat4, feat8, feat16, feat4_up, feat8_up, feat16_up, feat32_up # x8, x16
...
class SpatialPath(nn.Module):
    def __init__(self, *args, **kwargs):
        ...
        self.conv1 = ConvBNReLU(3, 8, ks=7, stride=2, padding=3)
        self.conv2 = ConvBNReLU(8, 16, ks=3, stride=1, padding=1)
        # self.conv3 = ConvBNReLU(64, 64, ks=3, stride=2, padding=1)
        self.conv_out = ConvBNReLU(16, 32, ks=1, stride=1, padding=0)
        self.init_weight()
...
class BiSeNet(nn.Module):
    def __init__(self, backbone, n_classes, pretrain_model='', use_boundary_2=False, use_boundary_4=False, use_boundary_8=False, use_boundary_16=False, use_conv_last=False, heat_map=False, *args, **kwargs):
        ...
        if backbone == 'STDCNet1446':
            ...
            sp8_inplanes = 256
            sp16_inplanes = 512
            inplane = sp2_inplanes + conv_out_inplanes
    ...
    def forward(self, x):
        ...
        feat_res2, feat_res4, feat_res8, feat_res16, feat_cp2, feat_cp4, feat_cp8, feat_cp16 = self.cp(x)
        ...
        feat_fuse = self.ffm(feat_res2, feat_cp2)
